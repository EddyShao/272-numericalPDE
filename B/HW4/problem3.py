...
# # ---- Step 2: Compute the projection/normal form coefficients----

#### This is based on the references, I'm not quite sure about this ####

# find the first order derivative of the residual F_res
# compute the projection of the first order derivative onto the adjoint eigenvector psi
# alpha = <psi, D F_res(u_current, r_current) / dr>
# beta = <psi, D^2 F_res(u_current, r_current) / dr^2>
# sigma = <psi, F_res(u_current, r_current)>

# # ---- Step 3: Branch switching initial guess ----
# sign_cubic = sign(beta)  # ± 1
# epsilon = small_amplitude
# delta_r = small_parameter_step * sign_cubic
# u_switch_init = u_current + epsilon * phi
# r_switch_init = r_current + delta_r

# # ---- Step 4: Continuation on the new branch ----
