...
def compute_tangent_vector(U, h, N, b2, r):
    ...
    A = np.vstack([np.hstack([J_U.toarray(), F_r[:, None]]), np.hstack([x_star, np.array([[0]])])])
...
solutions, params = arclength_continuation(U_0, h, N, b2, r, ds=0.1, num_steps=20)
