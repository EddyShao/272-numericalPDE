...
def compute_tangent(U, r, h, N, b2, dr_prev):
    ...
    A_bottom = tangent_temp.reshape(1, -1)
...
def main():
    ...
    N = len(x)
    b2 = 1.0
    r0 = -1.2  # initial bifurcation parameter
    ...
    for step in range(1, max_steps):
        ...
        tangent_new = compute_tangent(U_new, r_new, h, N, b2, tangent_prev[-1])
