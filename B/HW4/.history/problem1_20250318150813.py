...
eigenvalues = np.linalg.eigvals(J.toarray())
# find the 4 largest dominant eigenvalues
eigenvalues = np.sort(eigenvalues * r)[-4:]
print("Eigenvalues of J = ", eigenvalues)
