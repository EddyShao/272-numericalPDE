...
from GMRES import gmres, jacobian_vector_product
...
if __name__ == "__main__":
    ...
    r = -0.2
    u, error_hist = newton_krylov_solver(u0, h, r, F_u, tol=1e-5)

    # u0 = 0.001 * np.sin(2*np.pi*x_space / L)  # Initial guess
    # r = 0.2
    # u, error_hist = newton_krylov_solver(u0, h, r, F_u)

    # u0 = 0.0001 * np.sin(2*np.pi*x_space / L)  # Initial guess
    # r = 0.2
    # u, error_hist = newton_krylov_solver(u0, h, r, F_u)
